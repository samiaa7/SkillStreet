-- =============================================
-- 1. SKILL (insert first, no dependencies)
-- =============================================
...
-- =============================================
-- 2. USERS (insert second, no dependencies)
-- =============================================
...
-- Sarah Ahmed teaches Python (skill_id 1) and Web Development (skill_id 2)
INSERT INTO user_skill (user_id, skill_id, level, is_teaching) VALUES
(2, 1, 'expert',        TRUE),
(2, 2, 'intermediate',  TRUE);

-- Bilal Khan teaches Pakistani Cooking (skill_id 6) and Baking (skill_id 7)
INSERT INTO user_skill (user_id, skill_id, level, is_teaching) VALUES
(3, 6, 'expert',        TRUE),
(3, 7, 'intermediate',  TRUE);

-- Nadia Hussain teaches Home Workout (skill_id 8)
INSERT INTO user_skill (user_id, skill_id, level, is_teaching) VALUES
(4, 8, 'expert',        TRUE);

-- Omar Farooq teaches Guitar (skill_id 10)
INSERT INTO user_skill (user_id, skill_id, level, is_teaching) VALUES
(5, 10, 'expert',       TRUE);

-- Learner skills (what they want to learn)
INSERT INTO user_skill (user_id, skill_id, level, is_teaching) VALUES
(6,  1,  'beginner',      FALSE),  -- Zara learning Python
(6,  9,  'beginner',      FALSE),  -- Zara learning Sketching
(7,  6,  'beginner',      FALSE),  -- Hassan learning Cooking
(7,  8,  'beginner',      FALSE),  -- Hassan learning Fitness
(8,  9,  'intermediate',  FALSE),  -- Ayesha learning Drawing
(8,  2,  'beginner',      FALSE),  -- Ayesha learning Web Dev
(9,  3,  'beginner',      FALSE),  -- Usman learning Excel
(9,  2,  'beginner',      FALSE),  -- Usman learning Web Dev
(10, 7,  'beginner',      FALSE),  -- Maryam learning Baking
(10, 4,  'beginner',      FALSE);  -- Maryam learning English
...
-- Bookings for session 3 (Biryani Masterclass — completed)
...
-- Bookings for session 1 (Python Basics — open)
INSERT INTO booking (session_id, learner_id, status, amount_paid, booked_at, updated_at) VALUES
...
-- only for completed bookings (booking_id 1 and 2)
-- =============================================

-- Hassan reviews Bilal (booking 1 — Biryani Masterclass)
...
-- Maryam reviews Bilal (booking 2 — Biryani Masterclass)
INSERT INTO review (booking_id, reviewer_id, reviewee_id, rating, comment) VALUES
(2, 10, 3,
 4,
...
-- Messages on booking 1 (Hassan + Bilal — Biryani)
...
-- Messages on booking 3 (Zara + Sarah — Python)
INSERT INTO message (booking_id, sender_id, receiver_id, body, is_read, sent_at) VALUES
...
-- Messages on booking 6 (Hassan + Nadia — Workout)
INSERT INTO message (booking_id, sender_id, receiver_id, body, is_read, sent_at) VALUES
...
-- Messages on booking 8 (Ayesha + Omar — Guitar)
INSERT INTO message (booking_id, sender_id, receiver_id, body, is_read, sent_at) VALUES
